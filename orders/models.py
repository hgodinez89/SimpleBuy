...
class Order(models.Model):
    ...
    def get_total(self):
        return round((self.cart.total + self.shipping_total - decimal.Decimal(self.get_discount())), 2)

    def cancel(self):
        self.status = OrderStatus.CANCELED

        promo_code = PromoCode.objects.get_promo_code(self.promo_code)
    ...
    def description(self):
        return _('Compra por ({}) productos ').format(
